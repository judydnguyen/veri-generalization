        ...
        def _bound_oneside(last_A, d_pos, d_neg, b_pos, b_neg):
            ...
            if isinstance(last_A, torch.Tensor):
                ...
                try:
                    ...
                    print("jit_mutiply failed:", e)
                    print("Shapes:")
                    print(pos_A.patches.shape, pos_A.patches.numel())
                    print(neg_A.patches.shape, neg_A.patches.numel())
                    print(d_pos.shape, d_pos.numel())
                    print(d_neg.shape, d_neg.numel())
                    # return last_A, bias  # fallback without crashing
