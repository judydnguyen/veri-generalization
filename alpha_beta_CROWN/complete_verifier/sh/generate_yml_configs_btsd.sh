#!/bin/bash
# Script to generate YAML config files for GTSRB CNN verification (BTSD / BTSC-mapped properties)
# Usage: ./generate_yml_configs_btsd.sh [model_paths...] [--root_path PATH] [--eps_values "1 2 3 4"] [--output_dir PATH] [--model_name NAME]
...
# Default values for BTSD (same GTSRB model/dataset, BTSD vnnlib specs)
DATASET="btsd"
...
DEFAULT_OUTPUT_DIR="${PROJECT_ROOT}/alpha_beta_CROWN/complete_verifier/exp_configs/generalizability/btsd"
...
echo "================================================================================"
echo "Generating YAML Config Files for GTSRB CNN (BTSD)"
echo "================================================================================"
echo ""
echo "Configuration:"
...
for MODEL_PATH in "${MODEL_PATHS[@]}"; do
    ...
    # Format epsilon as "Xover255" for BTSD CSV filename
    CSV_NAME="btsd_instances_eps${EPS}over255.csv"
...
#   bash generate_yml_configs_btsd.sh
# Or with explicit paths:
#   bash generate_yml_configs_btsd.sh --root_path "${PROJECT_ROOT}/generate_properties/gtsrb/btsd" \
#     --output_dir "${PROJECT_ROOT}/alpha_beta_CROWN/complete_verifier/exp_configs/generalizability/btsd" \
