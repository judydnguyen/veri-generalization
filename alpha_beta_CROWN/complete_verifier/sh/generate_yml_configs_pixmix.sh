#!/bin/bash
# Script to generate YAML config files for PixMix OOD MNIST verification
# Usage: ./generate_yml_configs_pixmix.sh [model_paths...] [--root_path PATH] [--eps_values "1 2 3 4"] [--output_dir PATH] [--model_name NAME]
...
echo "================================================================================"
echo "Generating YAML Config Files for PixMix OOD MNIST Verification"
echo "================================================================================"
echo ""
echo "Configuration:"
...
for MODEL_PATH in "${MODEL_PATHS[@]}"; do
    ...
    for EPS in $EPS_VALUES; do
        # Format epsilon as "Xover255" for CSV filename (matches generate_pixmix_mnist_properties.py)
        CSV_NAME="mnist_ood_instances_eps${EPS}over255.csv"
