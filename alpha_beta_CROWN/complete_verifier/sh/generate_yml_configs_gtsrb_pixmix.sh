#!/bin/bash
# Script to generate YAML config files for GTSRB CNN verification (PixMix OOD properties)
# Usage: ./generate_yml_configs_gtsrb_pixmix.sh [model_paths...] [--root_path PATH] [--eps_values "1 2 3 4"] [--output_dir PATH] [--model_name NAME]
...
# Default values for GTSRB PixMix OOD
DATASET="gtsrb"
...
# Root path: where generate_pixmix_gtsrb_properties.py outputs (gtsrb_ood_instances_eps*over255.csv)
DEFAULT_ROOT_PATH="${PROJECT_ROOT}/generate_properties/gtsrb/gtsrb_ood_pixmix"
DEFAULT_EPS_VALUES="1 2 3 4"
DEFAULT_OUTPUT_DIR="${PROJECT_ROOT}/alpha_beta_CROWN/complete_verifier/exp_configs/generalizability/gtsrb_pixmix"
...
echo "================================================================================"
echo "Generating YAML Config Files for GTSRB CNN (PixMix OOD)"
echo "================================================================================"
echo ""
echo "Configuration:"
...
for MODEL_PATH in "${MODEL_PATHS[@]}"; do
    ...
    # Format epsilon as "Xover255" for PixMix OOD CSV filename
    CSV_NAME="gtsrb_ood_instances_eps${EPS}over255.csv"
...
# USAGE (defaults use PROJECT_ROOT; run from repo or pass paths):
#   bash generate_yml_configs_gtsrb_pixmix.sh
# Or with explicit paths:
#   bash generate_yml_configs_gtsrb_pixmix.sh --root_path "${PROJECT_ROOT}/generate_properties/gtsrb/gtsrb_ood_pixmix" \
#     --output_dir "${PROJECT_ROOT}/alpha_beta_CROWN/complete_verifier/exp_configs/generalizability/gtsrb_pixmix" \
