...
########################################
# Cusomized models go here
########################################

class SimpleCNN(nn.Module):
    """Simple CNN for MNIST/CIFAR10 classification"""
    ...
    def __init__(self, num_classes=10, input_channels=1):
        ...
        # For MNIST (28x28) -> 3x3 -> 14x14 -> 7x7 -> 3x3
...
def resnet_cifar10():
    return SimpleResNet(num_classes=10, input_channels=3)
