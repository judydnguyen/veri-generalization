...
CIFAR10C_DATA_DIR = "/home/judy/code/unlearning-verification/alpha_beta_CROWN/complete_verifier/datasets/cifar10c_by_class"
def load_cifar10c_data(
    data_dir: str = CIFAR10C_DATA_DIR,
    num_imgs: int = 25,
    random: bool = False
) -> tuple:
    """
...
def create_csv():
    ...
    with open('../cifar10c_resnet_instances_0.01.csv', 'w') as f:
        write = csv.writer(f)
...
def create_vnnlib(args):
    ...
    images, labels = load_cifar10c_data(num_imgs=10000, random=not args.deterministic)
